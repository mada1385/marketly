...
class LocaleText {
  ...
  factory LocaleText.fromJson(Map<String, dynamic> json) => LocaleText(
        ...
        resendOTP:
            json["resend OTP"] == null ? "Resend OTP" : json["resend OTP"],
        isRequired:
            json["is required"] == null ? "is required" : json["is required"],
        price: json["price"] == null ? "Price" : json["Price"],
        writeYourReview: json["Write Your Review"] == null
            ? "Write Your Review"
            : json["Write Your Review"],
        thankYouForYourMessage: json["Thank you for your Message"] == null
            ? "Thank you for your Message"
            : json["Thank you for your Message"],
        date: json["Date"] == null ? "Date" : json["Date"],
        priceHighToLow: json["Price High to Low"] == null
            ? "Price High to Low"
            : json["Price High to Low"],
        priceLowToHigh: json["Price Low to High"] == null
            ? "Price Low to High"
            : json["Price Low to High"],
        popular: json["Popular"] == null ? "Popular" : json["Popular"],
        rating: json["Rating"] == null ? "Rating" : json["Rating"],
        processing:
            json["Processing"] == null ? "Processing" : json["Processing"],
        completed: json["Completed"] == null ? "Completed" : json["Completed"],
        pendingPayment: json["Pending Payment"] == null
            ? "Pending Payment"
...
class Block {
  ...
  factory Block.fromJson(Map<String, dynamic> json) => Block(
        ...
        categories: json["categories"] == null
            ? null
            : List<Category>.from(
                json["categories"]["cats"].map((x) => Category.fromJson(x))),
...
class Settings {
  ...
  factory Settings.fromJson(Map<String, dynamic> json) => Settings(
        ...
        switchWebViewCheckout: json["switchWebViewCheckout"] == null
            ? null
            : json["switchWebViewCheckout"],
        disableGuestCheckout: json["disableGuestCheckout"] == null
            ? null
            : json["disableGuestCheckout"],
        defaultCountry:
